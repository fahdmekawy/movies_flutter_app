...
import 'package:movies_flutter_app/bloc/get_movie_detail_bloc.dart';
import 'package:movies_flutter_app/model/movie_detail.dart';
...
class _MovieInfoState extends State<MovieInfo> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<MovieDetailResponse>(
        ...
        builder: (contex, AsyncSnapshot<MovieDetailResponse> snapshot) {
          if (snapshot.hasData) {
