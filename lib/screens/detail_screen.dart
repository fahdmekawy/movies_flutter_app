...
import 'package:movies_flutter_app/bloc/get_movie_videos.dart';
import 'package:movies_flutter_app/model/movie.dart';
import 'package:movies_flutter_app/model/video.dart';
...
import 'package:movies_flutter_app/widgets/casts.dart';
import 'package:movies_flutter_app/widgets/movie_info.dart';
import 'package:movies_flutter_app/widgets/similar_movies.dart';
...
class _MovieDetailScreenState extends State<MovieDetailScreen> {
        ...
        builder: (context) {
          return SliverFab(
            ...
            floatingWidget: StreamBuilder<VideoResponse>(
                ...
                builder: (contex, AsyncSnapshot<VideoResponse> snapshot) {
                  if (snapshot.hasData) {
  ...
  Widget _buildPersonsWidget(VideoResponse data) {
    List<Video> video = data.videos;
